...
const Contacts: React.FC = () => { // компонент страницы Договор оферты
    ...
    return (
        <>
            ...
            <h1 className="text-center pt-20 text-2xl tracking-tight font-extrabold text-fuchsia-600 dark:text-white">Контакты</h1>

            <div className="container my-4 px-6 mx-auto dark:bg-gray-900">
                ...
                <section className="pb-32 text-gray-800">
                    ...
                    <div className="relative overflow-hidden bg-no-repeat bg-cover"
                        style={{
                            ...
                            backgroundImage: `url(/img/banner-contacts.jpg)`,
                        }}
                    ></div>
